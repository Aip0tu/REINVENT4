...
from .dataprocess.data import set_cache_mol, preprocess_smiles_columns
from .dataprocess.features import get_available_features_generators
...
class CommonArgs(Tap):
    ...
    def features_scaling(self) -> bool:
        """
        Whether to apply normalization with a :class:`~flam.data.scaler.StandardScaler`
